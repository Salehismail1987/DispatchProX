...
declare var $: any;
@Component({
  selector: 'app-contact-tc-drivers',
  templateUrl: './contact-tc-drivers.component.html',
  styleUrls: ['./contact-tc-drivers.component.css']
})
export class ContactTcDriversComponent implements OnInit {
  active_menu: any;
  loggedinUser: any;
