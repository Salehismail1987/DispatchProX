...
@Component({
  selector: 'app-trucking-company-tragget-ticket',
  templateUrl: './trucking-company-tragget-ticket.component.html',
  styleUrls: ['./trucking-company-tragget-ticket.component.css']
})
export class TruckingCompanyTraggetTicketComponent implements OnInit {
