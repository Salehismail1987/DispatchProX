...
@Component({
  selector: 'app-approved-job-detail',
  templateUrl: './approved-job-detail.component.html',
  styleUrls: ['./approved-job-detail.component.css']
})
export class ApprovedJobDetailComponent implements OnInit {
