...
@Component({
  selector: 'app-freelance-approved-job-detail',
  templateUrl: './freelance-approved-job-detail.component.html',
  styleUrls: ['./freelance-approved-job-detail.component.css']
})
export class FreelanceApprovedJobDetailComponent implements OnInit {
  ...
  getTicketDetail(){
    ...
    let filter = {user_id:this.loggedinUser.user_data_request_id ? this.loggedinUser.user_data_request_id : this.loggedinUser?.id,id: this.driver_ticket_id};
    let data:any={
