...
@Component({
  selector: 'app-cancelled-ticket-detail',
  templateUrl: './cancelled-ticket-detail.component.html',
  styleUrls: ['./cancelled-ticket-detail.component.css']
})
export class CancelledTicketDetailComponent implements OnInit {
