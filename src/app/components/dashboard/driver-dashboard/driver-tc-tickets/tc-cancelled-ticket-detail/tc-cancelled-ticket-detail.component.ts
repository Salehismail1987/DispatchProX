...
@Component({
  selector: 'app-tc-cancelled-ticket-detail',
  templateUrl: './tc-cancelled-ticket-detail.component.html',
  styleUrls: ['./tc-cancelled-ticket-detail.component.css']
})
export class TcCancelledTicketDetailComponent implements OnInit {
