...
declare var $: any;
@Component({
  selector: 'app-tc-request-job-detail',
  templateUrl: './tc-request-job-detail.component.html',
  styleUrls: ['./tc-request-job-detail.component.css']
})
export class TcRequestJobDetailComponent implements OnInit {
 ...
 constructor(
  ...
  getTicketDetail(){
    ...
    let data = {date:this.date_today,is_tc_ticket:'YES',user_id:this.loggedinUser?.id ? this.loggedinUser?.id: this.loggedinUser?.user_data_request_id,driver_ticket_id: this.driver_ticket_id};
  ...
  handleAcceptTicket(driver_ticket:any){
    let data = {
      is_tc_ticket:'YES',
      user_id:this.loggedinUser?.id ? this.loggedinUser?.id: this.loggedinUser?.user_data_request_id,
      ticket_id:driver_ticket.ticket_id
    };
