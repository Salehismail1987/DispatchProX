...
@Component({
  ...
  templateUrl: './completed-job-detail.component.html',
  styleUrls: ['./completed-job-detail.component.css']
})
export class CompletedJobDetailComponent implements OnInit {
  ...
  moveToStatus(status:any,dt_id:any){
    if(status=='Accepted'){
      ...
      window.location.href= "/completed-job-detail/"+dt_id;
