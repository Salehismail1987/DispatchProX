...
declare var $: any;
@Component({
  selector: 'app-request-job-detail',
  templateUrl: './request-job-detail.component.html',
  styleUrls: ['./request-job-detail.component.css']
})
export class RequestJobDetailComponent implements OnInit {
