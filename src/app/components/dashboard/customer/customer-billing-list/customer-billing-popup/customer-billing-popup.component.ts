...
@Component({
  selector: 'app-customer-billing-popup',
  templateUrl: './customer-billing-popup.component.html',
  styleUrls: ['./customer-billing-popup.component.css']
})
export class CustomerBillingPopupComponent implements OnInit {
