...
@Component({
  selector: 'app-approver-projects',
  templateUrl: './approver-projects.component.html',
  styleUrls: ['./approver-projects.component.css']
})
export class ApproverProjectsComponent implements OnInit {
  loggedinUser: any = {};
  message:any;
