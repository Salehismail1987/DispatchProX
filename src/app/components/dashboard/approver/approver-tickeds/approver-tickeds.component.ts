...
@Component({
  selector: 'app-approver-tickeds',
  templateUrl: './approver-tickeds.component.html',
  styleUrls: ['./approver-tickeds.component.css']
})
export class ApproverTickedsComponent implements OnInit {
