...
@Component({
  selector: 'app-tc-approver-approved-tickets',
  templateUrl: './tc-approver-approved-tickets.component.html',
  styleUrls: ['./tc-approver-approved-tickets.component.css']
})
export class TcApproverApprovedTicketsComponent implements OnInit {
  ...
  constructor(
    ...
    this.active_menu = {
      parent:'tickets',
      child:'tc_approver_approved_tickets',
      count_badge: '',
    }
  }
  ...
  getTicketListing() {
    ...
    formData.append('search_status', 'Approved');
