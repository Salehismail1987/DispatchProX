...
@Component({
  selector: 'app-approver-approved-tickets',
  templateUrl: './approver-approved-tickets.component.html',
  styleUrls: ['./approver-approved-tickets.component.css']
})
export class ApproverApprovedTicketsComponent implements OnInit {
  ...
  constructor(
    ...
    this.active_menu = {
      parent:'tickets',
      child:'approver_approved_tickets',
      count_badge: '',
    }
  }
