...
declare var $: any;
@Component({
  selector: 'app-tc-user-profile',
  templateUrl: './tc-user-profile.component.html',
  styleUrls: ['./tc-user-profile.component.css']
})
...
//     const topicData = {
//         user_id: 1, // Replace with the dynamic user ID if required
//         topic_title: this.helpTopicForm.value.topic_title,
//         detail: this.helpTopicForm.value.detail // Corrected to match the form control name
//     };
...
//             this.helpTopicForm.reset(); // Reset the form on success
//         },
//         (error) => {
