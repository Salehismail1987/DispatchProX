...
(function($) {
    ...
    function onSelect(dateText, inst) {
        ...
        selectweek = startDate.getFullYear() + "/" + (startDate.getMonth() + 1) + "/" + startDate.getDate() + ' - ' + endDate.getFullYear() + "/" + (endDate.getMonth() + 1) + "/" + endDate.getDate();
        $('.selectcontroldiv').hide();
        $('.selmonthtype').val(selectweek);
